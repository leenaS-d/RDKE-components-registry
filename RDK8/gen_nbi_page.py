...
def build_northbound() -> None:
    ...
    build_api(
        ...
        active="northbound",
        title="Northbound API Spec",
        description="The RDK8 Northbound API Spec provides a consistent app-facing layer for web and native applications to access RDK8 platform services through Firebolt.",
